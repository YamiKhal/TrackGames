				...
				if (social.kind === LinkType.COPY) {
					return (
						...
						>
							...
							{copied && (
								<span className="pointer-events-none absolute -top-7 left-1/2 -translate-x-1/2 whitespace-nowrap rounded bg-success px-2 py-0.5 text-[0.65rem] font-bold text-bg shadow-main">
									Copied!
								</span>
							)}
						</button>
