...
export default function ConfirmAction({ open, title, message, confirmLabel, pending, requireText, requireLabel, onClose, onConfirm }: { open: boolean; title: ReactNode; message: ReactNode; confirmLabel: string; pending?: boolean; requireText?: string; requireLabel?: string; onClose: () => void; onConfirm: () => void }) {
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex justify-end gap-2">
                    ...
                    {needsText && step === 1 ? (
                        ...
                        <GhostButton type="button" onClick={onConfirm} disabled={pending || !canConfirm} className="border-error px-4 py-2 text-error hover:border-error hover:text-error disabled:cursor-wait disabled:opacity-60">
