...
export default function StarRating({ rating, size = 12, interactive = false, showValue = false, name, onChange }: { rating?: number | null; size?: number; interactive?: boolean; showValue?: boolean; name?: string; onChange?: (value: number) => void }) {
    ...
    return (
        <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-0.5" onPointerLeave={() => setHover(null)} aria-label={rating != null ? `Rating ${rating} out of 5` : "No rating"}>
