                ...
                {games.length > 0 ? (
                    <>
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-3">
                            {hasMore ? (
                                <Link href={`/search?${nextParams}`} scroll={false} className="rounded bg-primary px-5 py-2 text-sm font-semibold text-bg transition-colors hover:bg-primary-hover">
                                    Load more
                                </Link>
                            ) : null}
                        </div>
