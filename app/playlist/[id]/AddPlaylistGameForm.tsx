                ...
                <div className="relative">
                    ...
                    {(query || game) && (
                        <button type="button" onClick={() => {
                            ...
                            setResults([]);
                            setGame(null);
                        }} className="absolute right-2 top-1/2 grid size-7 -translate-y-1/2 cursor-pointer place-items-center rounded text-text-faint hover:text-primary" aria-label="Clear game">
                            <X size={16} />
                        </button>
                    )}
                </div>
