...
export default async function Image({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return createOpenGraphImage({
        ...
        label: "Game",
        description: metadataDescription(game?.summary, game ? `Track ratings, playtime, playlists, and community activity for ${game.name}.` : "The requested game could not be found."),
