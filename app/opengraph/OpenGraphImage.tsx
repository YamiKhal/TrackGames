...
export async function createOpenGraphImage({ title, description, label = "TrackGames", image, coverImage, libraryGameCount, playlistGameCount, primaryColor, playlistImages = [], variant = "site" }: OpenGraphImageProps) {
    ...
    const brand = (
        <div style={{ display: "flex", alignSelf: "flex-start", alignItems: "center", gap: "18px" }}>
            <img
                ...
                height="72"
                alt=""
                style={{ width: "72px", height: "72px", borderRadius: "18px" }}
            />
    ...
    const dissolveBackground = (
        <div style={{ position: "absolute", left: 0, top: 0, width: "1200px", height: "630px", display: "flex", zIndex: 0 }}>
            ...
            <div style={{ position: "absolute", right: "260px", top: 0, width: "260px", height: "100%", background: `linear-gradient(90deg, rgba(${dissolveRgb}, 0) 0%, rgba(${dissolveRgb}, 0.4) 62%, ${dissolveColor} 100%)` }} />
            {[
                ...
                <div key={index} style={{ position: "absolute", right: `${square.right}px`, top: `${square.top}px`, width: `${square.size}px`, height: `${square.size}px`, background: dissolveColor, opacity: square.opacity }} />
            ))}
        </div>
    );
    ...
    if (variant === "game") {
        return new ImageResponse(
            <div style={{ width: "100%", height: "100%", display: "flex", position: "relative", overflow: "hidden", background: "#14151a", color: "#F4F0FF", fontFamily: "Inter, Manrope, Arial, sans-serif" }}>
                {imageSrc && (
                    <img src={imageSrc} width="1200" height="630" alt="" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />
                )}
                <div style={{ position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(12,13,18,0.18) 0%, rgba(12,13,18,0.24) 48%, rgba(12,13,18,0.86) 100%)" }} />
                {coverSrc && (
                    <div style={{ position: "absolute", left: "20px", bottom: "20px", width: "170px", height: "238px", display: "flex", overflow: "hidden", border: "3px solid #2A2633", borderRadius: "8px", background: "#24212b", boxShadow: "0 18px 30px rgba(0,0,0,0.36)" }}>
                        <img src={coverSrc} width="170" height="238" alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                    </div>
                )}
                <div style={{ position: "absolute", right: "20px", bottom: "20px", width: "78px", height: "78px", display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "20px", background: "rgba(16,17,22,0.72)", boxShadow: "0 18px 30px rgba(0,0,0,0.35)", opacity: 0.5 }}>
                    <img
                        src={iconSrc}
                        width="58"
                        height="58"
                ...
                <div style={{ position: "absolute", left: coverSrc ? "218px" : "82px", right: "126px", bottom: "20px", display: "flex", flexDirection: "column", alignItems: "flex-start", gap: "10px" }}>
                    <div style={{ display: "flex", flexDirection: "column", gap: "10px", maxWidth: "100%" }}>
                        <div style={{ color: "#D6A85C", alignSelf: "flex-start", fontSize: "25px", fontWeight: 800, textTransform: "uppercase", background: "rgba(16,17,22,0.6)", borderRadius: "12px", padding: "10px 14px" }}>{label}</div>
                        <div style={{ fontSize: titleSize, lineHeight: 1.02, fontWeight: 900, letterSpacing: "0", background: "rgba(16,17,22,0.6)", borderRadius: "12px", padding: "10px 14px" }}>{title}</div>
                    </div>
                </div>
            </div>,
            size,
    ...
    if (variant === "profile") {
        return new ImageResponse(
            <div style={{ width: "100%", height: "100%", display: "flex", position: "relative", overflow: "hidden", background: "#14151a", color: "#F4F0FF", fontFamily: "Inter, Manrope, Arial, sans-serif" }}>
                {dissolveBackground}
                <div style={{ position: "absolute", right: "86px", top: "116px", width: "330px", height: "330px", display: "flex", borderRadius: "4px", border: "10px solid #232633", background: "#14151a", overflow: "hidden", zIndex: 1 }}>
                    {imageSrc ? (
                        <img src={imageSrc} width="330" height="330" alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                    ) : (
                        <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", color: "#9A7BFF", fontSize: "150px", fontWeight: 900 }}>{title.slice(0, 1)}</div>
                    )}
                </div>
                <div style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", justifyContent: "space-between", width: "100%", padding: "58px 82px 74px" }}>
                    {brand}
            ...
            <div style={{ width: "100%", height: "100%", display: "flex", position: "relative", overflow: "hidden", background: "#14151a", color: "#F4F0FF", fontFamily: "Inter, Manrope, Arial, sans-serif" }}>
                ...
                <div style={{ position: "absolute", right: "74px", top: "96px", width: "486px", height: "248px", display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "4px", zIndex: 2 }}>
                    <div style={{ position: "relative", width: "210px", height: "168px", display: "flex" }}>
                        ...
                        <div style={{ position: "absolute", left: "24px", top: "44px", width: "48px", height: "8px", borderRadius: "999px", background: "#F4F0FF", opacity: 0.68 }} />
                        <div style={{ position: "absolute", left: "24px", top: "78px", width: "36px", height: "8px", borderRadius: "999px", background: "#F4F0FF", opacity: 0.48 }} />
                        <div style={{ position: "absolute", right: "24px", top: "44px", width: "48px", height: "8px", borderRadius: "999px", background: "#F4F0FF", opacity: 0.68 }} />
                        <div style={{ position: "absolute", right: "24px", top: "78px", width: "36px", height: "8px", borderRadius: "999px", background: "#F4F0FF", opacity: 0.48 }} />
                    </div>
                </div>
                ...
                <div style={{ position: "relative", zIndex: 3, display: "flex", flexDirection: "column", justifyContent: "space-between", width: "100%", padding: "58px 82px 74px" }}>
                    {brand}
    ...
    if (variant === "playlist") {
        return new ImageResponse(
            <div style={{ width: "100%", height: "100%", display: "flex", position: "relative", overflow: "hidden", background: "#14151a", color: "#F4F0FF", fontFamily: "Inter, Manrope, Arial, sans-serif" }}>
                <div style={{ position: "absolute", inset: 0, background: "linear-gradient(110deg, rgba(20,21,26,1) 0%, rgba(20,21,26,0.94) 52%, rgba(154,123,255,0.28) 100%)" }} />
                <div style={{ position: "absolute", right: "74px", top: "82px", display: "flex", width: "486px", height: "376px" }}>
                    {[0, 1, 2, 3].map((index) => (
                        <div key={index} style={{ position: "absolute", left: `${index * 74}px`, top: `${index * 10}px`, zIndex: 40 - index * 10, width: "206px", height: "288px", display: "flex", overflow: "hidden", border: "4px solid #2A2633", borderRadius: "8px", background: "#24212b", boxShadow: "0 22px 36px rgba(0,0,0,0.35)" }}>
                            {playlistImages[index] ? (
                                <img src={playlistImages[index]} width="206" height="288" alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                            ) : (
                                <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", background: "#24212b", color: "#9A7BFF", fontSize: "54px", fontWeight: 900 }}>{index + 1}</div>
                            )}
                        </div>
                    ))}
                </div>
    ...
    return new ImageResponse(
        <div style={{ width: "100%", height: "100%", display: "flex", background: "#14151a", color: "#F4F0FF", fontFamily: "Inter, Manrope, Arial, sans-serif", position: "relative", overflow: "hidden" }}>
            <div style={{ display: "flex", opacity: 0.2}}>
                {dissolveBackground}
            </div>
            <div style={{ position: "relative", display: "flex", flexDirection: "column", justifyContent: "center", gap: "42px", width: "100%", padding: "76px 96px" }}>
                {brand}
